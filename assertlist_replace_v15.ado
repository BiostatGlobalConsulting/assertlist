*! assertlist_replace version 1.03 - Biostat Global Consulting - 2019-01-16
...
* 2019-01-16	1.03	MK Trimner		Added fmtid for excel formatting
*										removed any putexcel formatting and added to fmtids
*******************************************************************************
*
* Contact Dale Rhoda (Dale.Rhoda@biostatglobal.com) with comments & suggestions.
*
capture program drop assertlist_replace_v15
program define assertlist_replace_v15
			...
			forvalues n = 1/`=_N' {
				...
				* Now complete the replace statements
				...
				if !inlist("`=_al_correct_var_`i'[`n']'","",".") ///
					putexcel  `xlcolname'`=`n'+1' = `"`=_al_replace_var_`i'[`n']'"'
