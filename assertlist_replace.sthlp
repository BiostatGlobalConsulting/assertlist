...
Biostat Global Consulting created three additional programs that go along with {cmd:assertlist_replace} : 
...
{pmore}{cmd:Assertlist_cleanup} Cleans up excel file generated by {cmd: assertlist}. {p_end}
